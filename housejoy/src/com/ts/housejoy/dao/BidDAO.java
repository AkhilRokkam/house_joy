	...
	public static boolean add(Bid bid) {
		...
		try {
			...
			ps = (PreparedStatement) con
					.prepareStatement("insert into bid(bid_price,bid_date,status,comments) values(?,?,0,?)");
			ps.setFloat(1, bid.getBidPrice());
			ps.setDate(2, (Date) bid.getBidDate());
			ps.setString(3, String.valueOf(bid.getStatus()));
			ps.setString(3, bid.getComments());
