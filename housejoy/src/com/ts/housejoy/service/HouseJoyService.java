...
public class HouseJoyService {
	...
	public boolean addServiceType(Service serviceType) {
		return ServiceDAO.add(serviceType);
	}

	public boolean deleteServiceType(int serviceTypeId) {
		return ServiceDAO.delete(serviceTypeId);
	}

	public Service getServiceType(int serviceTypeId) {
		return ServiceDAO.get(serviceTypeId);
	}

	public List<Service> getServiceTypes(int subCategoryId) {
		return ServiceDAO.getServices(subCategoryId);
	}

	public List<Service> getForceServiceTypes(int userId) {
