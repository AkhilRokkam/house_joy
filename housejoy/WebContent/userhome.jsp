...
<body>
	<nav class="navbar navbar-default navbar-expand-lg navbar-light">
		<div class="navbar-header d-flex col">
			<a class="navbar-brand" href="HouseJoyController?action=user_home">House<b>Joy</b></a>
		...
		<div id="navbarCollapse"
			...
			<ul class="nav navbar-nav">
				...
				<li class="nav-item dropdown"><a data-toggle="dropdown"
					class="nav-link dropdown-toggle" href="#">Profile<b
						class="caret"></b></a>
					<ul class="dropdown-menu">
						<li><a href="HouseJoyController?action=user_profile"
							class="dropdown-item">Edit Profile</a></li>
					</ul></li>
				<li class="nav-item"><a href="HouseJoyController?action=logout"
	...
	<div class="bs-example">
		<div class="container">
			...
			<c:forEach var="category" items="${categories}">
				...
				<div class="col-xs-3">
					<a href="HouseJoyController?action=${category.id}"
						class="thumbnail"> <img
